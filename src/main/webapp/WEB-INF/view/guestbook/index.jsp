    ...
    <body style="padding: 20px">
        ...
        <form class="pure-form" method="post" action="/YIDWebDemo/guestbook">
            <fieldset>
                ...
                Mode: <input type="text" name="mode" value="${ mode }" readonly/><p>
                <!---------------------------------------------------------------------->
        ...
        <table class="pure-table pure-table-bordered">
            <thead>
                <tr>
                    <td>id</td><td>category</td><td>username</td><td>email</td>
                    <td>message</td><td>update time</td><td>create time</td>
